...
namespace Seal { namespace Object {
	...
	public:
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newAmbientLight();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newCamera();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newCone();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newDirectionalLight();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newCube();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newGameObject(const 
				Seal::Geometry::Model &model);
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newIcosphere();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newPlane();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newPointLight();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newSphere();
		...
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newSpotLight();
		...
		/// The pointer to the Sphere Object.
		/// </returns>
		std::unique_ptr<Seal::Object::GameObject> newSuzanne();
	private:
		/// <summary>
		...
		std::unique_ptr<GameObject> newDefaultImport(
				const Seal::Geometry::Model &model,
