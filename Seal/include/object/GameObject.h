...
namespace Seal { namespace Component { class GameComponent; } }
namespace Seal { namespace Scene { class GameScene; } }
namespace Seal { namespace Component { namespace Light { 
	class BaseLight; } } }
...
namespace Seal { namespace Object {
	...
	class GameObject {
		friend class Seal::Scene::GameScene;
	public:
		/// <summary>
		...
		/// </exception>
		Seal::Component::GameComponent& addComponent(std::unique_ptr<
				Seal::Component::GameComponent> component);
		...
		Seal::Component::GameComponent& addComponent(TArgs&&... args) {
			Seal::Component::GameComponent::assertIsBaseOf<T>();

			std::unique_ptr<Seal::Component::GameComponent> component =
		...
		/// </returns>
		const Seal::Scene::GameScene* getScene() const;
		...
		/// Object.
		/// </returns>
		bool hasComponent(const Seal::Component::GameComponent 
				*component) const;
		...
		/// </param>
		virtual void onRender(Seal::Shader::ShaderProgram &shader);
		...
		/// removed.
		/// </exception>
		std::unique_ptr<Seal::Component::GameComponent> 
				removeComponent(Seal::Component::GameComponent 
				*component);
	...
	protected:
		...
		Seal::Scene::GameScene *scene; // Scene to which this belongs to
		...
		mutable std::vector<std::vector<std::unique_ptr<
				Seal::Component::GameComponent>>> components;
		...
		/// </returns>
		std::vector<std::unique_ptr<Seal::Component::GameComponent>>&
		...
		std::vector<std::unique_ptr<Seal::Component::GameComponent>>&
			...
			unsigned int id = Seal::Component::GameComponent::
		...
		/// checks that this is not null.
		/// </param>
		virtual void onAttach(Seal::Scene::GameScene *scene);
		...
		/// assertion checks that this is not null.
		/// </param>
		virtual void onDetach(Seal::Scene::GameScene *scene);
