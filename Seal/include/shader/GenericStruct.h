...
namespace Seal { namespace Shader {
	/// <summary>
	...
	public:
		...
		/// value.
		/// </returns>
		VariableMap<Seal::Math::Matrix4f>& getMatrix4fs();
		...
		/// its value.
		/// </returns>
		const VariableMap<Seal::Math::Matrix4f>& getMatrix4fs() const;
		...
		/// value.
		/// </returns>
		VariableMap<std::shared_ptr<const Seal::Graphics::Texture2D>>& 
				getSampler2Ds();
		...
		const VariableMap<std::shared_ptr<
				const Seal::Graphics::Texture2D>>& getSampler2Ds() const;
		...
		/// value.
		/// </returns>
		VariableMap<Seal::Math::Vector2f>& getVector2fs();
		...
		/// its value.
		/// </returns>
		const VariableMap<Seal::Math::Vector2f>& getVector2fs() const;
		...
		/// value.
		/// </returns>
		VariableMap<Seal::Math::Vector3f>& getVector3fs();
		...
		/// its value.
		/// </returns>
		const VariableMap<Seal::Math::Vector3f>& getVector3fs() const;
		...
		/// value.
		/// </returns>
		VariableMap<Seal::Math::Vector4f>& getVector4fs();
		...
		/// its value.
		/// </returns>
		const VariableMap<Seal::Math::Vector4f>& getVector4fs() const;
	...
	protected:
		...
		mutable VariableMap<Seal::Math::Matrix4f> glMatrix4fs;
		mutable VariableMap<Seal::Math::Vector2f> glVector2fs;
		mutable VariableMap<Seal::Math::Vector3f> glVector3fs;
		mutable VariableMap<Seal::Math::Vector4f> glVector4fs;
		mutable VariableMap<std::shared_ptr<
				const Seal::Graphics::Texture2D>> glSampler2Ds;
