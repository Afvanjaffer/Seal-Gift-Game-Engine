...
namespace Seal { namespace Scene {
	class GameScene : public Seal::Object::GameObject {
		friend class Seal::Component::Light::BaseLight;
	public:
		/// <summary>
		...
		/// </returns>
		Seal::Object::GameObject& addChild(
			std::unique_ptr<Seal::Object::GameObject> object) override;
		...
		const std::vector<std::reference_wrapper<
				Seal::Component::Light::BaseLight>>& getSceneLights()
				const;
		...
		/// </exception>
		std::unique_ptr<Seal::Object::GameObject> removeChild(
				Seal::Object::GameObject *object) override;
	private:
		static GameScene *activeScene; // The active game scene

		// List of all of the lights of this scene
		std::vector<
			std::reference_wrapper<Seal::Component::Light::BaseLight>> 
			sceneLights;
	};
} }
