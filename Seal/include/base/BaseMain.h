...
namespace Seal { namespace Base { class BaseGame; } }
namespace Seal { namespace Render { class RenderingEngine; } }

namespace Seal { namespace Base {
	class BaseMain {
	public:
		/// <summary>
		...
		/// <summary>
		/// Runs the specified game using the Seal Game Engine.
		/// </summary>
		/// <param name="game">
	...
	private:
		BaseGame *game;
		Seal::Render::RenderingEngine *renderingEngine;
