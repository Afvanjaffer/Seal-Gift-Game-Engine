...
namespace Seal { namespace Component { namespace Render {
	...
	public:
		...
		/// </param>
		void addMaterial(const std::shared_ptr<Seal::Graphics::Material> 
				&material);
		...
		/// </param>
		void addMesh(const std::shared_ptr<Seal::Geometry::Mesh> &mesh);
		...
		/// </returns>
		std::vector<std::shared_ptr<Seal::Graphics::Material>>& 
				getMaterials();
		...
		/// </returns>
		const std::vector<std::shared_ptr<Seal::Graphics::Material>>& 
				getMaterials() const;
		...
		/// </returns>
		std::vector<std::shared_ptr<Seal::Geometry::Mesh>>& getMeshes();
		...
		/// </returns>
		const std::vector<std::shared_ptr<Seal::Geometry::Mesh>>& 
				getMeshes() const;
		...
		/// Mesh Renderer.
		/// </param>
		void onRender(Seal::Shader::ShaderProgram &shader) override;
		...
		void removeMaterial(const 
				std::shared_ptr<Seal::Graphics::Material> &material);
		...
		/// </param>
		void removeMesh(const std::shared_ptr<Seal::Geometry::Mesh> 
				&mesh);
	private:
		// The list of meshes and materials of this Mesh Renderer.
		std::vector<std::shared_ptr<Seal::Geometry::Mesh>> meshes;
		std::vector<std::shared_ptr<Seal::Graphics::Material>> materials;
