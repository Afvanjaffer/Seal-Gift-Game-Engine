...
namespace Seal { namespace Component { namespace Render {
	class CameraController : 
		...
		public Seal::Shader::GenericStruct {
	public:
		...
		/// </summary>
		/// <returns></returns>
		const Seal::Math::Matrix4f& getProjection() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& getProjectionOrientation() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& getProjectionTranslation() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& getProjectionView() const;
	...
	private:
		...
		Seal::Component::Physics::Transform *transform;

		mutable Seal::Math::Matrix4f projection;      // Full Projection
		mutable Seal::Math::Matrix4f projectionView;  // View
		mutable Seal::Math::Matrix4f projectionOrien; // Orientation
		mutable Seal::Math::Matrix4f projectionTrans; // Translation
		...
		/// </returns>
		const Seal::Math::Matrix4f& calcProjection() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& calcProjectionOrientation() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& calcProjectionTranslation() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& calcProjectionViewOrthographic() 
				const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& calcProjectionViewPerspective() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& calcProjectionView() const;
