...
namespace Seal { namespace Object { class GameObject; } }

namespace Seal { namespace Component {
	...
	public:
		...
		/// </returns>
		Seal::Object::GameObject* getAttached();
		...
		/// </returns>
		const Seal::Object::GameObject* getAttached() const;
	...
	protected:
		...
		Seal::Object::GameObject* attached;
	...
	public:
		...
		GameComponentDisallowsMultipleException(
			const Seal::Object::GameObject *object,
