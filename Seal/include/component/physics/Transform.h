...
namespace Seal { namespace Component { namespace Physics {
	enum Space {
	...
	class Transform : public GameComponent {
		friend class Seal::Object::GameObject;
	public:
		/// <summary>
		...
		/// </param>
		Transform(const Seal::Math::Vector3f &pos,
			const Seal::Math::Quaternion &rot,
			const Seal::Math::Vector3f &scl);
		...
		/// </returns>
		Seal::Conjuncture::Event& getChangedEvent();
		...
		/// </returns>
		const Seal::Conjuncture::Event& getChangedEvent() const;
		...
		/// </returns>
		const Seal::Math::Quaternion& getGlobalRotation() const;
		...
		/// The scale vector.
		/// </returns>
		const Seal::Math::Vector3f& getGlobalScale() const;
		...
		/// </returns>
		const Seal::Math::Vector3f& getGlobalTranslation() const;
		...
		/// </returns>
		const Seal::Math::Vector3f& getLocalForward() const;
		...
		/// </returns>
		const Seal::Math::Vector3f& getLocalRight() const;
		...
		/// </returns>
		const Seal::Math::Quaternion& getLocalRotation() const;
		...
		/// </returns>
		const Seal::Math::Vector3f& getLocalScale() const;
		...
		/// </returns>
		const Seal::Math::Vector3f& getLocalTranslation() const;
		...
		/// The local up vector.
		/// </returns>
		const Seal::Math::Vector3f& getLocalUp() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& getMatrixOrientation() const;
		...
		/// The rotation matrix.
		/// </returns>
		const Seal::Math::Matrix4f& getMatrixRotation() const;
		...
		/// The scale matrix.
		/// </returns>
		const Seal::Math::Matrix4f& getMatrixScale() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& getMatrixTransformation() const;
		...
		/// </returns>
		const Seal::Math::Matrix4f& getMatrixTranslation() const;
		...
		/// </returns>
		Seal::Math::Vector3f inverseTransformDirection(
			const Seal::Math::Vector3f &dir) const;
		...
		/// </returns>
		Seal::Math::Vector3f inverseTransformPoint(
			const Seal::Math::Vector3f &pos) const;
		...
		/// </param>
		void setRotation(const Seal::Math::Quaternion &rot,
		...
		/// specified, global is used by default.
		/// </param>
		void setScale(const Seal::Math::Vector3f &scl, 
			const Space &space = Space::GLOBAL);
		...
		/// specified, global is used by default.
		/// </param>
		void setTranslation(const Seal::Math::Vector3f &pos, 
			const Space &space = Space::GLOBAL);
		...
		/// </param>
		void rotate(const Seal::Math::Vector3f &axis, const float &rad,
		...
		/// axis.
		/// </param>
		void rotateAround(const Seal::Math::Vector3f &center, 
			const Seal::Math::Vector3f &axis, const float &rad);
		...
		/// </returns>
		Seal::Math::Vector3f transformDirection(
			const Seal::Math::Vector3f &dir) const;
		...
		/// </returns>
		Seal::Math::Vector3f transformPoint(
			const Seal::Math::Vector3f &p) const;
		...
		/// is used by default.
		/// </param>
		void translate(const Seal::Math::Vector3f &vec, 
			const Space &space = Space::LOCAL);
	...
	private:
		...
		mutable Seal::Math::Vector3f lclTranslation;    // Local Position
		mutable Seal::Math::Quaternion lclRotation;     // Local Rotation
		mutable Seal::Math::Vector3f lclScale;          // Local Scale

		mutable Seal::Math::Vector3f gblTranslation;    // Global Position
		mutable Seal::Math::Quaternion gblRotation;     // Global Rotation
		mutable Seal::Math::Vector3f gblScale;          // Global Scale

		mutable Seal::Math::Vector3f forward;           // Local Forward
		mutable Seal::Math::Vector3f right;             // Local Right
		mutable Seal::Math::Vector3f up;                // Local Up
		...
		// should it be dirty.
		mutable Seal::Math::Matrix4f transformMatrix;   // Transf. Mat
		mutable Seal::Math::Matrix4f translationMatrix; // Translation Mat
		mutable Seal::Math::Matrix4f rotationMatrix;    // Rotation Mat
		mutable Seal::Math::Matrix4f scaleMatrix;       // Scale Mat
		mutable Seal::Math::Matrix4f orientationMatrix; // Orientation Mat
		...
		Seal::Conjuncture::Event changedEvent;          // This Changed
		Seal::Conjuncture::EventHandler parentChanged;  // Parent Changed
		...
		/// The orientation matrix.
		/// </returns>
		const Seal::Math::Matrix4f& calculateOrientationMatrix() const;
		...
		/// The rotation matrix.
		/// </returns>
		const Seal::Math::Matrix4f& calculateRotationMatrix() const;
		...
		/// The scale matrix.
		/// </returns>
		const Seal::Math::Matrix4f& calculateScaleMatrix() const;
		...
		/// The rotation matrix.
		/// </returns>
		const Seal::Math::Matrix4f& calculateTransformationMatrix()
				const;
		...
		/// The translation matrix.
		/// </returns>
		const Seal::Math::Matrix4f& calculateTranslationMatrix() const;
