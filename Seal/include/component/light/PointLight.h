...
namespace Seal { namespace Component { namespace Light {
	...
	public:
		...
		PointLight(const float &inten, const Seal::Math::Vector3f &col, 
				const Seal::Component::Light::Attenuation &atten, const 
				float &ran);
		...
		Seal::Component::Light::Attenuation& getAttenuation();

		/// Returns the attenuation of this Point Light.
		/// return : The constant reference to the Attenuation.
		const Seal::Component::Light::Attenuation& getAttenuation() const;
		...
		void setAttenuation(const Seal::Component::Light::Attenuation& 
				atten);
		...
		void toShader(Seal::Shader::ShaderProgram &shader,
	...
	private:
		...
		Seal::Component::Light::Attenuation attenuation;

		const Seal::Math::Vector3f *position; // Transform Position
