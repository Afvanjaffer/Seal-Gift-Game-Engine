...
namespace Seal { namespace Component { namespace Light {
	...
	class BaseLight : 
			...
			public Seal::Component::GameComponent {
	public:
		...
		BaseLight(const Seal::Shader::ShaderSource &src, const 
		...
		void setColor(const Seal::Math::Vector3f &col);
	...
	public:
		...
		void setProjection(const Seal::Math::Matrix4f &proj);
