...
namespace Seal { namespace Geometry {
	...
	public:
		...
		/// </param>
		Vertex(const Seal::Math::Vector3f &pos,
				const Seal::Math::Vector3f &norm,
				const Seal::Math::Vector3f &tan,
				const Seal::Math::Vector2f &tc0);
		...
		/// The normal vector.
		/// </returns>
		const Seal::Math::Vector3f& getNormal() const;
		...
		/// The position vector.
		/// </returns>
		const Seal::Math::Vector3f& getPosition() const;
		...
		/// The tangent vector.
		/// </returns>
		const Seal::Math::Vector3f& getTangent() const;
		...
		/// </returns>
		const Seal::Math::Vector2f& getTexCoords0() const;
		...
		/// The normal vector.
		/// </param>
		void setNormal(const Seal::Math::Vector3f &norm);
		...
		/// The position vector.
		/// </param>
		void setPosition(const Seal::Math::Vector3f &pos);
		...
		/// The tangent vector.
		/// </param>
		void setTangent(const Seal::Math::Vector3f &tan);
		...
		/// The index zero texture coordinates vector.
		/// </param>
		void setTexCoords0(const Seal::Math::Vector2f &uv);
	private:
		...
		Seal::Math::Vector3f position;     // Model Position           (0)
		Seal::Math::Vector3f normal;       // Model Normal             (1)
		Seal::Math::Vector3f tangent;      // Model Tangent            (2)

		Seal::Math::Vector2f texCoords0;   // Texture Coordinates 0    (3)
	};
} }
