...
namespace Seal { namespace Math { class Matrix4f; } }
namespace Seal { namespace Math { class Quaternion; } }

namespace Seal { namespace Math {
	/// <summary>
	...
	public:
		/// <summary>
		/// Returns the Seal global forward vector ( 0, 0, -1 ).
		/// </summary>
		/// <returns>
		...
		/// <summary>
		/// Returns the Seal global right vector ( 1, 0, 0 ).
		/// </summary>
		/// <returns>
		...
		/// <summary>
		/// Returns the Seal global up vector ( 0, 1, 0 ).
		/// </summary>
		/// <returns>
