...
namespace Seal { namespace Render { namespace Deferred {
	...
	class GBuffer : public Seal::Base::GLItem {
		friend class DeferredRenderer;
	public:
		// Event Handler for the Window Resize Event
		Seal::Conjuncture::EventHandler windowResizeHandler;
		...
		///							will be drawn.
		void bindDrawLight(Seal::Shader::ShaderProgram &shader);
		...
		void bindDrawLight(Seal::Shader::ShaderProgram &shader, const
				Seal::Component::Light::LightType &type);
		...
		///							is to be binded.
		void bindTexture(const GBufferTextureType &type, Seal::Shader::
		...
		///							are to be binded.
		void bindColorTextures(Seal::Shader::ShaderProgram &shader);
	...
	private:
		...
		std::unique_ptr<Seal::Graphics::Texture2D> bufferTextures
