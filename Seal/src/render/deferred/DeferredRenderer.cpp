...
using Seal::Component::Light::LightType;
using Seal::Component::Light::Shadow;
using Seal::Component::Light::ShadowType;
using Seal::Component::Physics::Transform;
using Seal::Component::Render::CameraController;
using Seal::Component::Render::MeshRenderer;
using Seal::Geometry::Mesh;
using Seal::Geometry::Model;
using Seal::Geometry::Vertex;
using Seal::Graphics::Texture2D;
using Seal::Math::Matrix4f;
using Seal::Math::Vector2f;
using Seal::Math::Vector3f;
using Seal::Math::Vector4f;
using Seal::Math::Utils::PI;
using Seal::Object::GameObjectFactory;
using Seal::Object::GameObject;
using Seal::Scene::GameScene;
using Seal::Shader::ShaderType;
...
namespace Seal { namespace Render { namespace Deferred {
	...
	const std::string DeferredRenderer::POINT_LIGHT_VOLUME_MODEL =
		"../Seal GE/res/models/light-volumes/pointLight.fbx";
	const std::string DeferredRenderer::SPOT_LIGHT_VOLUME_MODEL =
		"../Seal GE/res/models/light-volumes/spotLight.fbx";
	...
	void DeferredRenderer::render(Seal::Scene::GameScene &scene) {
	...
	void DeferredRenderer::initializeShaders() {
		...
		this->ambientShader.addShader("../Seal GE/res/shaders/"
		...
		this->directionalLightShader.addShader("../Seal GE/res/shaders/"
			"render/deferred/geometry/simpleVS.glsl", 
			ShaderType::VERTEX_SHADER);
		this->directionalLightShader.addShader("../Seal GE/res/shaders/"
		...
		this->pointLightShader.addShader("../Seal GE/res/shaders/"
		...
		this->spotLightShader.addShader("../Seal GE/res/shaders/"
			"render/deferred/light/blinn-phong/lightVS.glsl",
			ShaderType::VERTEX_SHADER);
		this->spotLightShader.addShader("../Seal GE/res/shaders/"
		...
		this->geometryShader.addShader("../Seal GE/res/shaders/"
		...
		this->stencilShader.addShader("../Seal GE/res/shaders/"
		...
		this->quadShader.addShader("../Seal GE/res/shaders/"
			"render/deferred/geometry/simpleVS.glsl", 
			ShaderType::VERTEX_SHADER);
		this->quadShader.addShader("../Seal GE/res/shaders/"
