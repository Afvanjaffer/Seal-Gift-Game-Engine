...
using Seal::Graphics::Cubemap;
using Seal::Graphics::Texture2D;
using Seal::Graphics::TextureFilterMagMode;
using Seal::Graphics::TextureDataFormat;
using Seal::Graphics::TextureDataInternalFormat;
using Seal::Graphics::TextureDataType;
using Seal::Graphics::TextureWrapMode;
...
namespace Seal { namespace Render {
	...
	void Renderer::setSolidColor(const Seal::Math::Vector4f &col) {
		this->solidColor = col;
	}
	...
	void Renderer::initializeCubemapDependencies() {
		...
		this->skyboxShader.addShader("../Seal GE/res/shaders"
		...
		this->solidColorShader.addShader("../Seal GE/res/shaders"
			"/cubemap/skyboxVS.glsl", ShaderType::VERTEX_SHADER);
		this->solidColorShader.addShader("../Seal GE/res/shaders"
	...
	void Renderer::initializeFXAAShader() {
		...
		this->fxaaShader.addShader("../Seal GE/res/shaders/render/"
	...
	void Renderer::initializeGammaShader() {
		...
		this->gammaShader.addShader("../Seal GE/res/shaders/render/"
	...
	void Renderer::initializeShadowMapDependencies() {
		...
		this->cShadowMapShader.addShader("../Seal GE/res/shaders/render/"
		...
		this->cShadowMapLinearShader.addShader("../Seal GE/res/shaders/"
		...
		this->vShadowMapShader.addShader("../Seal GE/res/shaders/render/"
		...
		this->vShadowMapLinearShader.addShader("../Seal GE/res/shaders/"
		...
		this->vsmGaussianBlurShader.addShader("../Seal GE/res/shaders/"
