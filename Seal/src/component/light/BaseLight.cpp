...
namespace Seal { namespace Component { namespace Light {
	...
	BaseLight::BaseLight(const Seal::Shader::ShaderSource &src, const
	...
	void BaseLight::setColor(const Seal::Math::Vector3f &col) {
		this->getColor() = col;
	}
	...
	const std::string Attenuation::STRUCT_FILE = "../Seal GE/res/"
	...
	const std::string Shadow::STRUCT_FILE = "../Seal GE/res/"
		"shaders/standard/structs/light/stdBaseLight.glsl";
