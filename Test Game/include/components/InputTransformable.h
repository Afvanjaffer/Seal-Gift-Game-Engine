...
#include "../../../Seal GE/include/component/GameComponent.h"
#include "../../../Seal GE/include/component/physics/Transform.h"

namespace SealTest { namespace Components {
	class InputTransformable : public Seal::Component::GameComponent {
	public:
		...
		InputTransformable(int mF, int mB, int mL, int mR, int mU, int mD,
			...
			float sM, float sR, float sS, Seal::Component::Physics::Space 
			space);
		...
		/// </returns>
		virtual Seal::Component::GameComponentID 
		...
		Seal::Component::Physics::Space& getSpace();
	...
	private:
		...
		Seal::Component::Physics::Space space;
