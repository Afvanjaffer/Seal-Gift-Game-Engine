...
#include "../../../Seal GE/include/base/GameTime.h"
#include "../../../Seal GE/include/base/GameInput.h"
#include "../../../Seal GE/include/math/Vector3f.h"

using Seal::Base::GameInput;
using Seal::Component::GameComponentID;
