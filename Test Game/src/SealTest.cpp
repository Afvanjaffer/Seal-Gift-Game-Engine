...
#include "../../Seal GE/include/render/Renderer.h"
#include "../../Seal GE/include/render/deferred/DeferredRenderer.h"
#include "../include/components/InputTransformable.h"
#include "../../Seal GE/include/debug/Logger.h"

using namespace SealEngine;
using namespace SealTest::Components;
using Seal::Debug::Logger;
using Seal::Render::Renderer;
...
namespace SealTest {
	...
	void TestGame::start() {
		...
		std::string skyboxDir =
			"../Seal GE/res/textures/default/aurora_skybox/";
		...
		GameWindow::getGameWindow()->setWindowTitle("Seal Test Game"); 
	}
